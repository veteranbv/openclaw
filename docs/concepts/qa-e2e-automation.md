...
contacts, locations, and stickers. QA Lab imports that driver through the narrow
`@openclaw/whatsapp/qa-driver-api.js` package surface instead of reaching into
private WhatsApp runtime files. Message content is redacted by default. Outbound
